...
export const OrderCardUI: FC<OrderCardUIProps> = memo(
  ({ orderInfo, maxIngredients, locationState }) => {
    ...
    const shouldShowStatus = location.pathname.startsWith('/profile/orders');
    ...
    return (
      ...
      >
        ...
        {shouldShowStatus && <OrderStatus status={orderInfo.status} />}
        ...
        <div className={`pt-6 ${styles.order_content}`}>
          <ul className={styles.ingredients}>
            {orderInfo.ingredientsToShow.map((ingredient, index) => {
              ...
              const hasRemains = orderInfo.remains > 0;
              ...
              return (
                ...
                >
                  <img
                    style={{
                      opacity: isLastVisible && hasRemains ? 0.5 : 1
                    }}
